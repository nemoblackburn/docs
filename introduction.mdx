...
3. Test your API key using the [API Reference](https://api.usetapestry.dev/docs). You can send test requests from this page.
4. Try this simple request to get all the followers of a popular wallet address.
    ```jsx
    fetch('https://api.usetapestry.dev/profile/followers/2qrWc9p5vatLH3kp4CiVXrdQ4V293d8qzmg4ziez6T4k?apiKey=YOUR_API_KEY')
    ```
